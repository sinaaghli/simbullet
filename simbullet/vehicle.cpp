...
class Vehicle : public CommonRigidBodyBase
{
public:
	/* extra stuff*/
	...
	Vehicle(struct GUIHelperInterface* helper);
...
Vehicle::Vehicle(struct GUIHelperInterface* helper)
...
void Vehicle::physicsDebugDraw(int debugFlags)
{
...
void Vehicle::stepSimulation(float deltaTime)
{
	float dt = deltaTime;
...
void Vehicle::displayCallback(void)
{
...
bool Vehicle::keyboardCallback(int key, int state)
{
	bool handled = false;
...
void Vehicle::specialKeyboardUp(int key, int x, int y)
{
}

void Vehicle::specialKeyboard(int key, int x, int y)
{
}
...
CommonExampleInterface* VehicleCreateFunc(struct CommonExampleOptions& options)
{
	return new Vehicle(options.m_guiHelper);
}
