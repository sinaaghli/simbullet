...
# Target
add_library(${LIBRARY_NAME} ${LIBRARY_TYPE} ${SOURCES} ${HEADERS} ${DEP_INCLUDE_DIRS} ${DEP_BULLET_INCLUDE_DIRS})
target_include_directories(${LIBRARY_NAME} SYSTEM BEFORE INTERFACE     
    "$<BUILD_INTERFACE:${DEP_BULLET_INCLUDE_DIRS}>"
    ${CMAKE_INSTALL_PREFIX}/${INCLUDE_INSTALL_DIR}
    )
# target_link_libraries(${LIBRARY_NAME} "$<BUILD_INTERFACE:${DEP_LIBS}>")
target_link_libraries(${LIBRARY_NAME} ${DEP_LIBS} ${DEP_BULLET_LIBS})

# Install library
install(TARGETS ${LIBRARY_NAME} ${DEP_BULLET_LIBS} 
